...
<html lang="en">
  <head>
    ...
    <title>Shoppe</title>
    <link rel="stylesheet" href="{{asset('public/fontend/css/style2.css')}}" />
    <link
      rel="stylesheet"
        ...
        <div class="grid">
          <nav class="header__navbar">
            ...
            <ul class="header__navbar-list">
			  ...
			  <li class="header__navbar-item">
                <img src="{{asset('public/fontend/images/avatar.jpg')}}" alt="" />
                <span class="header__navbar-item-link login"
                  >
				  <?php
